...
///// <summary>
///// FUTURE* Provides native library resolution for the chizl.colors library across supported platforms.
///// </summary>
...
//{
//    private const string LogicalName = "chizl.colors";
//    public static string LibaryName { get; set; } = "chizl.colors";
...
//        string mapped =
//            RuntimeInformation.IsOSPlatform(OSPlatform.Windows) ? "chizl.colors.dll" :
//            RuntimeInformation.IsOSPlatform(OSPlatform.OSX) ? "libchizl.colors.dylib" :
//                                                                 "libchizl.colors.so";
